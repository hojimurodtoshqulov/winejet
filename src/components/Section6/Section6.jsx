			...
			<div className="section6__container">
				...
				<div className="section6__img-wrapper">
					{isDesktop ? (
						...
						>
							<img src={`data:image/png;base64,${newsData?.[0]?.attachmentContents?.[0]?.data}`} alt="" />
						</motion.div>
					) : (
					...
					{isDesktop ? (
						<motion.div
							...
							transition={{ duration: 0.4, type: "tween" }}
						>
							<img src={`data:image/png;base64,${newsData?.[0]?.attachmentContents?.[1]?.data}`} alt="" />
						</motion.div>
					) : (
						<div className="section6__img">
							<img src={`data:image/png;base64,${newsData?.[0]?.attachmentContents?.[1]?.data}`} alt="" />
				...
				<div className="section6__img-wrapper">
					{isDesktop ? (
						...
						>
							<img src={`data:image/png;base64,${newsData?.[1]?.attachmentContents?.[1]?.data}`} alt="" />
						</motion.div>
					) : (
					...
					{isDesktop ? (
						<motion.div
							...
							className="section6__img2"
						>
							<img src={`data:image/png;base64,${newsData?.[1]?.attachmentContents?.[0]?.data}`} alt="" />
						</motion.div>
					) : (
						<div className="section6__img2">
							<img src={`data:image/png;base64,${newsData?.[1]?.attachmentContents?.[0]?.data}`} alt="" />
