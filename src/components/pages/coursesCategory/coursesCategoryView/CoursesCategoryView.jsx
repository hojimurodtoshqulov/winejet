...
const MyForm = () => {
  ...
  const { about } = useSelector((state) => state.admin);
  ...
  useEffect(() => {
    ...
    if (formType === constatns.form.updating) {
      setTitleUz(about.titleUz);
      setTitleRu(about.titleRu);
      setDescriptionUz(about.descriptionUz);
      setDescriptionRu(about.descriptionRu);
    }
  }, []);
  ...
  const handleEdit = async (event) => {
    ...
    const updatedData = {
      ...
      //   id: teacher.id,
      titleUz: titleUz || about.titleUz,
      titleRu: titleRu || about.titleRu,
      descriptionUz: descriptionUz || about.descriptionUz,
      descriptionRu: descriptionRu || about.descriptionRu,
      attachmentContentId: about?.attachmentContent?.id,
      id: about.id,
    };
    ...
    try {
      ...
      clearValues();
      navigation("/admin/about", { replace: true });
      NotificationManager.success("About text updated", "Success!");
      clearValues();
    } catch (error) {
      NotificationManager.error("Something went wrong", "Error!");
      console.log(error);
